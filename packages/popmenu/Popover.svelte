...
<script>
    ...
    import { forwardEventsBuilder, trapTabKey } from 'sui_helpers';

    const events = forwardEventsBuilder(get_current_component());
    const dispatch = createEventDispatcher();

    export { className as class, style, origin, top, left, visible, duration };
